...
import { createStaffAssignment } from 'apiSdk/staff-assignments';
...
function StaffAssignmentCreatePage() {
  ...
  const handleSubmit = async (values: StaffAssignmentInterface, { resetForm }: FormikHelpers<any>) => {
    setError(null);
    try {
      await createStaffAssignment(values);
      resetForm();
