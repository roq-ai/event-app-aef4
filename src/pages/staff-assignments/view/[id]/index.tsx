...
import { getStaffAssignmentById } from 'apiSdk/staff-assignments';
import { StaffAssignmentInterface } from 'interfaces/staff-assignment';

function StaffAssignmentViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Staff Assignment Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('staff_assignment', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/staff-assignments/edit/${id}`} passHref legacyBehavior>
                    <Button
