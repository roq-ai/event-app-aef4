...
async function handler(req: NextApiRequest, res: NextApiResponse) {
  ...
  async function createEvent() {
    ...
    if (body?.staff_assignment?.length > 0) {
      const create_staff_assignment = body.staff_assignment;
      body.staff_assignment = {
        create: create_staff_assignment,
      };
    } else {
      delete body.staff_assignment;
    }
