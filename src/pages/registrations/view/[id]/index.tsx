...
import { getRegistrationById } from 'apiSdk/registrations';
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('registration', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/registrations/edit/${id}`} passHref legacyBehavior>
                    <Button
                ...
                <FormListItem
                  ...
                  text={
                    data?.registration_time
                      ? format(parseISO(data?.registration_time as unknown as string), 'dd-MM-yyyy')
                      : ''
                  }
                />
