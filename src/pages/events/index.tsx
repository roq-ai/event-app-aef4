...
export function EventListPage(props: EventListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getEvents({
        relations: ['organization', 'registration.count', 'staff_assignment.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('organization', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('registration', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'registration',
          header: 'Registration',
          accessorKey: 'registration',
          cell: ({ row: { original: record } }: any) => record?._count?.registration,
        }
      : null,
    hasAccess('staff_assignment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'staff_assignment',
          header: 'Staff Assignment',
          accessorKey: 'staff_assignment',
          cell: ({ row: { original: record } }: any) => record?._count?.staff_assignment,
        }
      : null,
